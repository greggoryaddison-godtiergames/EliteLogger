...
#include "EliteDebuggerLibrary.generated.h"

/**
 * 
 */
UCLASS()
class ELITELOGGER_API UEliteDebuggerLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
	...
	UFUNCTION(BlueprintCallable, BlueprintInternalUseOnly)
		static bool SetFVectorByName(UObject* Target, FName VarName, FVector NewValue, FVector &OutValue);
	...
	UFUNCTION(BlueprintCallable, BlueprintInternalUseOnly)
		static bool GetFVectorByName(UObject* Target, FName VarName, FVector &OutValue);
